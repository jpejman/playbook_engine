"""
Debug single CVE runner for continuous_pipeline_v0_2_0
Version: v0.2.0
...
def main():
    parser = argparse.ArgumentParser(description='Debug single CVE runner v0.2.0')
