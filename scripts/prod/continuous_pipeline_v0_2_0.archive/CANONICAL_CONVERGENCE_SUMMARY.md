# Continuous Pipeline v0.2.0 — Canonical Prompt/Schema Convergence
...
```
Continuous Pipeline v0.2.0 — align generation path to canonical prompt builder and schema used by fixed Phase 1 runner
