...
PROMPTS = [
    "Write a 500-word essay on the history and future of artificial intelligence. Include milestones, ethical implications, and the impact on industries such as healthcare, education, and transportation.",
...
for model in MODELS:
    for idx, prompt in enumerate(PROMPTS):
        ...
        output_dir = f"./outputs/{VERSION}/{model}"
        ...
        if formatted and raw:
            ...
            print(f"Error for Model: {model}, Prompt {idx+1}: {formatted}")
