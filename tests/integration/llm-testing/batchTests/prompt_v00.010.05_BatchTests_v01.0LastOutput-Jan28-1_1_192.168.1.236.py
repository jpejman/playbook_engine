...
PROMPTS = [
    "Write a 50-word essay on the history and future of artificial intelligence. Include milestones, ethical implications, and the impact on industries such as healthcare, education, and transportation.",
    "Explain the ethical challenges posed by artificial intelligence in 50 words.",
    "Create a detailed guide for deploying AI models in cloud environments, including challenges and solutions (50 words)."
]
