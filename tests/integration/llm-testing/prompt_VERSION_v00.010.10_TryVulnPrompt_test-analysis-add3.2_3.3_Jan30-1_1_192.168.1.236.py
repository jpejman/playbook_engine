...
#MODELS = ["llama3.1:70b", "llama3.2:3b", "llama3.3:latest", "codellama"]
...
The CVE description highlights the root cause as: *Authd PAM module before version 0.3.5 can allow broker-managed users to impersonate any other user managed 
by the same broker and perform any PAM operation with it, including authenticating as them."
#    "write a 100 word essay on eggs"
]
