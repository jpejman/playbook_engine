...
# 📏 **Text Similarity Scoring is a good next step since it improves content accuracy evaluation. 🚀**
...
for i, prompt in enumerate(PROMPTS):
    ...
    for model in MODELS:
        ...
        if wc == 0 or tt == float("inf"):
            ...
            similarity_score = similarity_scores[model][i]
            final_score = (0.4 * completeness_score) + (0.3 * speed_score) + (0.3 * similarity_score)
