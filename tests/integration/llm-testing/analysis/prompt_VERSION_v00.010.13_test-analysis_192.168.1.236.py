...
MODELS = ["llama3.2-vision", "llama3.2:3b", "llama3.2:1b"]
PROMPTS = [
   """Write a detailed guide for deploying AI models in cloud environments, 
      including challenges and solutions (100 words).""",
   """Explain the ethical challenges posed by artificial 
      intelligence in 100 words.""",
